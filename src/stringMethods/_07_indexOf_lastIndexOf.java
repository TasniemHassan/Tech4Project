...
public class _07_indexOf_lastIndexOf {
    ...
    NOTE: if the given char or String does not exist, then it returns -1
    NOTE: if you are looking for an index of String and it exists, it will return the first index
        of first match
     */
        ...
        System.out.println("The index of empty = " + sentence.indexOf("")); // always 0
    }
}
