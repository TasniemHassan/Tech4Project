    ...
    public static void main(String [] args){
       ...
       56, 78, 63
        ...
        if(num1 != max && num1 != min){
            //num1 is middle, if it is NOT max and not min that means num1 is middles
            mid = num1;
        ...
        //if(num2 != max && num2 != min){
            //num2 is middle, if it is NOT max and not min that means num1 is middles
            //mid = num2;
        //}

        //if(num3 != max && num3 != min){
            //num3 is middle, if it is NOT max and not min that means num1 is middles
            //mid = num3;
        //}
