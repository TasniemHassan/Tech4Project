...
public class ArrayListVsLinkedList {
    public static void main(String[] args) {
        ...
        System.out.println(("\n---------------\n"));
        System.out.println(numbers.poll()); // gets the first element and removes it
        System.out.println(numbers.pollFirst()); // gets the first element and removes it
        ...
        numbers.push(8.9); // adds the object to the head(to the zeroth index)
