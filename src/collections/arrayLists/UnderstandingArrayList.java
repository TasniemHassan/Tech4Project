...
public class UnderstandingArrayList {
    public static void main(String[] args) {
        ...
        String[] namesArray = new String[5]; // when declaring array, always declare size
        ...
        //not static not void return type and returns an int

        // 3. How to add elements to Array vs ArrayList
        namesArray[0] = "Abe";
        namesArray[4] = "Data";
       // namesArray[7] = "John";// ArraysOutOfBoundsException
        ...
        namesList.add("Alona");// by default if no index specified it adds to the end
        //[Abe, John, data, Alona]
       ...
       // namesList.add(8, "Andrei"); // out of bounds, can add at most to the end and thats 6
        ...
        System.out.println(namesList.set(3, "Daria")); //when printed it will return Lionel
        ...
        namesList.remove(0); //James will be removed
        System.out.println(namesList);
       ...
       namesList.remove("Alona");
        ...
        System.out.println(namesList); // return same list bc Max is uppercase so list stays same


        namesList.add(0,"Regina");
        System.out.println(namesList);

        //How to get element at specific index
